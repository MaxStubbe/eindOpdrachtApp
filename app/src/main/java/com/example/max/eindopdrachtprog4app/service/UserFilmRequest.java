...
/**
 * Created by Jens Bax on 19-6-2017.
 */
...
public class UserFilmRequest    {
        ...
        private UserFilmRequest.FilmListener listener;


        public UserFilmRequest(Context context, UserFilmRequest.FilmListener listener) {
        ...
        public void handleGetAllFilms() {
            ...
            if (token != null && !token.equals("dummy default token")) {
                ...
                JsonArrayRequest jsObjRequest = new JsonArrayRequest
                        (Request.Method.GET, Config.URL_LEENFILM(customer_id), null, new Response.Listener<JSONArray>() {
